// TODO criar interface para as props
// TODO melhorar a estilização no botão para nao quebrar com pouco texto
// TODO mudar a cor padrao do projeto
export function NoteCard(props: unknown) {
  return (
    <button className="rounded-md text-left bg-slate-800 p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
      <span className="text-sm font-medium text-slate-300">Há 85 dias</span>
